/**
 * Created by Zhous on 2017/10/20.
 */
'use strict';
var Cesium = require('cesium');
var yargs = require('yargs');
var loadPlannetVecotr = require("../lib/loadPlannetVector")
var createBuildings3DTiles = require("../lib/createBuildings3DTiles")
...
//
loadPlannetVecotr(input, options).then(function(data) {
        return createBuildings3DTiles(data, options);
    }).then(function () {
